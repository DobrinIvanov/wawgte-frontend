...
<template>
  <div class="flex-row flex h-screen p-5 shadow-xl shadow-indigo-400 font-mono">
    ...
    <div class="flex flex-col w-screen">
      <div class="flex flex-rox h-20 justify-between">
        ...
        <div class=" flex-row justify-evenly flex items-end">
          <a href="/login">
            <button
              class="border-indigo-200 border flex h-9 w-auto
                    items-center justify-center p-4 m-2
                    bg-gradient-to-r from-stone-200 to-stone-300
                    rounded-lg shadow-md shadow-indigo-300">Login</button>
          </a>
          <a href="/sign-up">
            <button
              class="border-indigo-200 border flex h-9 w-auto
              items-center justify-center p-4 m-2
              bg-gradient-to-r from-stone-200 to-stone-300
              rounded-lg shadow-md shadow-indigo-300">SignUp</button>
          </a>
        </div>
      </div>
